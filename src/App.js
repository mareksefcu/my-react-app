    ...
    <div className="app-container">
      ...
      <div className="button-container">
        <button
          ...
          className="app-button create-category-button"
        >
          Vytvořit kategorii
        </button>
        <button
          onClick={handleCreateZapisekClick}
          className="app-button create-zapisek-button"
        >
          Vytvořit zápisek
        </button>
      </div>
      ...
      {showZapisekForm && (
        <div className="form-wrapper">
          <CreateZapisek onClose={() => setShowZapisekForm(false)}  />
        </div>
      )}
      <ZapisekList />
    </div>
